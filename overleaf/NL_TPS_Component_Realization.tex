...
\begin{document}
\NLSetPageStyle{NL-TPS COMPONENT REALIZATION}{Derived from NL-TPS Detailed Requirements v0.1 with corrected clinical-adapter allocation}
...
\NLMeta{Architecture version}{0.2 - Hazard-linked corrected component allocation}
\NLMeta{Date}{19 August 2026}
\NLMeta{Status}{Discussion Draft - Not for clinical use}
\NLMeta{Coverage}{119 high-level parents; 357 sub-requirements; 45 components; 15 teams}
...
\addlinespace[2pt]
Trace coverage & 357 of 357 sub-requirements mapped to a universal realization stack, direct components, and teams \\
\addlinespace[2pt]
Component count & 45 \\
\addlinespace[2pt]
Team count & 15 \\
...
This specification identifies the minimum candidate technical and program components needed to make each of the 357 NL-TPS sub-requirements real. Together, those sub-requirements realize the 119 high-level requirements; the high-level requirements in turn realize the Concept of Operations. The document therefore provides the first complete allocation bridge from operational intent to buildable and verifiable system elements.
...
\addlinespace[2pt]
C-ACC-01 & Clinical service & Accreditation Profile and Applicability Registry & Controls source program, authority, edition, integrity, atomic assertions, applicability, supersession, approval, and signed runtime-profile publication. & T-EVD \\
\addlinespace[2pt]
C-DOC-01 & Control & Clinical Documentation Completeness and Temporal Gate & Evaluates required fields, signatures, status, effective time, authoritative source, prerequisites, and review schedules without creating professional findings or signatures. & T-SYS \\
\addlinespace[2pt]
C-ACC-02 & Program & Accreditation Evidence, Deficiency, and Export Workspace & Links privacy-controlled evidence to controls and manages attestation, deficiency, CAPA, review, readiness reporting, and authorized export without deciding accreditation. & T-GOV \\
\addlinespace[2pt]
C-PBT-01 & Clinical service & Proton Planning and QA Profile Adapter & Binds commissioned proton modes, machines, CT configurations, algorithms, robustness, QA, external validation, beamline, readiness, and review controls to the active case and release. & T-PLAN \\
\addlinespace[2pt]
...
\addlinespace[2pt]
\mbox{GOV-005-01} & The identity service shall implement an institution-approved role-permission matrix that identifies allowed functions and incompatible responsibilities for each authorized clinical and technical role. & U-STACK + C-IAM-01; C-GOV-01; C-QMS-01; C-SAFE-01; C-STATE-01; C-ARCH-01 & Lead: T-SEC; partners: T-GOV\slash\allowbreak{}T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\mbox{GOV-005-02} & The safety kernel shall prevent one actor or service identity from satisfying approval steps that the active separation-of-duties policy defines as incompatible. & U-STACK + C-SAFE-01; C-STATE-01; C-IAM-01; C-ARCH-01 & Lead: T-SYS; partners: T-VV\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
...
\addlinespace[2pt]
\mbox{CLN-002-01} & The planning-context manifest shall identify the approved image studies, frames of reference, registrations, structure sets, prior-treatment information, and signed clinical intent by unique version. & U-STACK + C-CASE-01; C-DICOM-01; C-DICOM-02; C-OBJ-01; C-TPS-01; C-WF-01; C-REG-01; C-SEG-01 & Lead: T-IMG; partners: T-DATA\slash\allowbreak{}T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN\slash\allowbreak{}T-INT \\
\addlinespace[2pt]
\mbox{CLN-002-02} & Context validation shall reject a planning task with a missing, conflicting, stale, or incorrectly referenced required input. & U-STACK + C-CASE-01; C-DICOM-01; C-DICOM-02; C-SAFE-01; C-STATE-01; C-TPS-01; C-WF-01; C-REG-01 & Lead: T-IMG; partners: T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN\slash\allowbreak{}T-INT \\
\addlinespace[2pt]
\mbox{CLN-002-03} & The system shall preserve the validated planning-context manifest and bind it to every derived anatomy, intent, and candidate-plan version. & U-STACK + C-TPS-01; C-WF-01; C-REG-01; C-SEG-01 & Lead: T-DATA; partners: T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN\slash\allowbreak{}T-INT \\
\addlinespace[2pt]
...
\addlinespace[2pt]
\mbox{CLN-004-03} & The system shall prohibit a model or automated service from approving a generated contour or promoting it directly to an approved clinical state. & U-STACK + C-SAFE-01; C-STATE-01; C-MGW-01; C-MREG-01; C-SEG-01 & Lead: T-SYS; partners: T-VV\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
...
\addlinespace[2pt]
\mbox{CLN-006-02} & The lifecycle service shall block promotion to clinical-candidate status while any required contour validation is failed, unresolved, or stale. & U-STACK + C-SAFE-01; C-STATE-01; C-TPS-01; C-WF-01; C-SEG-01 & Lead: T-SYS; partners: T-VV\slash\allowbreak{}T-CLIN\slash\allowbreak{}T-INT \\
\addlinespace[2pt]
\mbox{CLN-006-03} & The system shall provide and retain a validation report identifying each check, result, affected structure, evidence, disposition, and reviewer. & U-STACK + C-UX-01; C-EVID-01; C-RULE-01; C-SEG-01 & Lead: T-UX; partners: T-DATA\slash\allowbreak{}T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
...
\addlinespace[2pt]
\mbox{CLN-007-02} & User edits shall create a new contour version and shall retain the changed region, editor, time, reason when required, and pre-edit geometry. & U-STACK + C-OBJ-01; C-UX-01; C-SEG-01 & Lead: T-DATA; partners: T-UX\slash\allowbreak{}T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\mbox{CLN-007-03} & Approval and export records shall identify the exact contour version, lineage, reviewer, approval state, and integrity value transferred downstream. & U-STACK + C-DICOM-01; C-DICOM-02; C-TPS-01; C-IAM-01; C-SAFE-01; C-STATE-01; C-TERM-01; C-SEG-01 & Lead: T-DATA; partners: T-INT\slash\allowbreak{}T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
...
\addlinespace[2pt]
\mbox{CLN-008-03} & Human-factors evaluation shall verify that representative users can find, interpret, edit, and confirm clinically important contour errors using the provided views. & U-STACK + C-HFE-01; C-UX-01; C-TEST-01; C-SEG-01 & Lead: T-UX; partners: T-VV\slash\allowbreak{}T-SYS\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
...
\addlinespace[2pt]
\mbox{CLN-009-01} & The approval configuration shall identify the authorized approval role for targets, organs at risk, derived structures, and each supported clinical workflow. & U-STACK + C-IAM-01; C-SBX-01; C-SAFE-01; C-STATE-01; C-SEG-01 & Lead: T-SEC; partners: T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\mbox{CLN-009-02} & The state engine shall require radiation-oncologist approval for clinical targets and shall enforce the configured authorized role before any structure becomes approved. & U-STACK + C-SAFE-01; C-STATE-01; C-IAM-01; C-SEG-01 & Lead: T-SYS; partners: T-VV\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\mbox{CLN-009-03} & Each structure approval shall bind the approver, role, contour version, review time, approval decision, and any conditions, and later edits shall invalidate the approval. & U-STACK + C-OBJ-01; C-IAM-01; C-SAFE-01; C-STATE-01; C-SEG-01 & Lead: T-DATA; partners: T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\end{longtable}
\end{scriptsize}
...
\addlinespace[2pt]
\mbox{PLN-002-01} & The release configuration shall list each commissioned planning, optimization, robustness, and dose-calculation service with its validated machine, technique, algorithm, and use envelope. & U-STACK + C-SBX-01; C-PLAN-01; C-WF-01; C-TPS-01; C-DICOM-01; C-DOSE-01 & Lead: T-SYS; partners: T-PLAN\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN\slash\allowbreak{}T-INT \\
\addlinespace[2pt]
\mbox{PLN-002-02} & The planning orchestrator shall verify the active request and configuration against the commissioned-use envelope before invoking a clinical planning or dose service. & U-STACK + C-SAFE-01; C-STATE-01; C-PLAN-01; C-WF-01; C-TPS-01; C-DICOM-01; C-DOSE-01 & Lead: T-SYS; partners: T-PLAN\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN\slash\allowbreak{}T-INT \\
\addlinespace[2pt]
\mbox{PLN-002-03} & The system shall record the service identity, version, approved configuration, envelope decision, input identity, and output identity for every candidate calculation. & U-STACK + C-TPS-01; C-WF-01; C-PLAN-01; C-DOSE-01 & Lead: T-DATA; partners: T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN\slash\allowbreak{}T-INT \\
\addlinespace[2pt]
...
\addlinespace[2pt]
\mbox{PLN-003-01} & The architecture shall separate language, speech, disease-site, and generative-model services from commissioned numerical dose-calculation components and credentials. & U-STACK + C-SAFE-01; C-STATE-01; C-VOICE-01; C-MGW-01; C-MREG-01; C-PLAN-01; C-DOSE-01 & Lead: T-SYS; partners: T-VV\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\mbox{PLN-003-02} & The planning orchestrator shall accept clinical dose only from an approved commissioned dose service and shall reject model-supplied dose arrays, dose metrics, or calculation attestations. & U-STACK + C-PLAN-01; C-WF-01; C-TPS-01; C-DICOM-01; C-OBJ-01; C-MGW-01; C-MREG-01; C-DOSE-01 & Lead: T-PLAN; partners: T-DATA\slash\allowbreak{}T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN\slash\allowbreak{}T-INT \\
\addlinespace[2pt]
\mbox{PLN-003-03} & Testing shall demonstrate rejection of spoofed, mislabeled, malformed, or model-generated dose results at every supported interface boundary. & U-STACK + C-TEST-01; C-SEC-01; C-IAM-01; C-MGW-01; C-MREG-01; C-PLAN-01; C-DOSE-01 & Lead: T-VV; partners: T-SEC\slash\allowbreak{}T-SYS\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
...
\addlinespace[2pt]
\mbox{PLN-005-01} & The state engine shall prohibit modification or relaxation of a hard constraint unless the active policy permits it and the user holds the required authorization. & U-STACK + C-SAFE-01; C-STATE-01; C-IAM-01; C-PLAN-01; C-DOSE-01; C-INTENT-01 & Lead: T-SYS; partners: T-SEC\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\mbox{PLN-005-02} & A permitted relaxation shall require an explicit action, structured rationale, and a pre-change and post-change difference review before recalculation or promotion. & U-STACK + C-UX-01; C-PLAN-01; C-WF-01; C-TPS-01; C-DICOM-01; C-DOSE-01 & Lead: T-UX; partners: T-PLAN\slash\allowbreak{}T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN\slash\allowbreak{}T-INT \\
\addlinespace[2pt]
\mbox{PLN-005-03} & The relaxed constraint shall create a new planning-intent version and shall retain the actor, authority, rationale, old and new values, affected candidates, and required reapprovals. & U-STACK + C-OBJ-01; C-IAM-01; C-SAFE-01; C-STATE-01; C-TPS-01; C-WF-01; C-PLAN-01; C-DOSE-01; C-INTENT-01 & Lead: T-DATA; partners: T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN\slash\allowbreak{}T-INT \\
\addlinespace[2pt]
...
\addlinespace[2pt]
\mbox{PLN-006-01} & The candidate-generation request shall contain the authorized requested candidate count and shall assign a unique identity to each attempted candidate. & U-STACK + C-PLAN-01; C-WF-01; C-TPS-01; C-DICOM-01; C-IAM-01; C-SAFE-01; C-STATE-01; C-DOSE-01 & Lead: T-PLAN; partners: T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN\slash\allowbreak{}T-INT \\
\addlinespace[2pt]
\mbox{PLN-006-02} & The system shall report generated, failed, infeasible, canceled, and pending candidates and shall state why the requested set was not completed. & U-STACK + C-PLAN-01; C-WF-01; C-TPS-01; C-DICOM-01; C-UX-01; C-DOSE-01; C-PBT-01 & Lead: T-PLAN; partners: T-UX\slash\allowbreak{}T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN\slash\allowbreak{}T-INT \\
\addlinespace[2pt]
\mbox{PLN-006-03} & The audit record shall retain the requested count, generation attempts, parameters, job states, results, and user decision to continue, retry, or accept a partial set. & U-STACK + C-JOB-01; C-PLAN-01 & Lead: T-DATA; partners: T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
...
\addlinespace[2pt]
\mbox{PLN-007-02} & The system shall calculate and present configured diversity descriptors against the parent candidate set without claiming clinically meaningful diversity from an unapproved threshold. & U-STACK + C-PLAN-01; C-WF-01; C-TPS-01; C-DICOM-01; C-REV-01; C-QA-01; C-MON-01; C-DOSE-01 & Lead: T-PLAN; partners: T-REV\slash\allowbreak{}T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN\slash\allowbreak{}T-INT \\
\addlinespace[2pt]
\mbox{PLN-007-03} & The candidate-set record shall retain the diversity method, configuration, descriptors, related candidates, and any user-directed variation. & U-STACK + C-TPS-01; C-WF-01; C-PLAN-01; C-DOSE-01 & Lead: T-DATA; partners: T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN\slash\allowbreak{}T-INT \\
\addlinespace[2pt]
...
\addlinespace[2pt]
\mbox{PLN-009-03} & The exact runtime manifest and comparison result shall be bound to each calculation output and candidate-plan version. & U-STACK + C-OBJ-01; C-TPS-01; C-WF-01; C-PLAN-01; C-DOSE-01 & Lead: T-DATA; partners: T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN\slash\allowbreak{}T-INT \\
\addlinespace[2pt]
...
\addlinespace[2pt]
\mbox{PLN-010-01} & Every dose quantity shall identify numeric units, physical or RBE-weighted basis, fractionation, normalization, biological transformation when approved, and applicable proton-specific assumptions. & U-STACK + C-OBJ-01; C-PLAN-01; C-WF-01; C-TPS-01; C-DICOM-01; C-TERM-01; C-DOSE-01; C-PBT-01; C-INTENT-01 & Lead: T-DATA; partners: T-PLAN\slash\allowbreak{}T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN\slash\allowbreak{}T-INT \\
\addlinespace[2pt]
\mbox{PLN-010-02} & The system shall prevent comparison, summation, or conversion of incompatible dose quantities unless an approved explicit transformation and its assumptions are applied. & U-STACK + C-SAFE-01; C-STATE-01; C-REV-01; C-QA-01; C-TPS-01; C-DICOM-01; C-PLAN-01; C-DOSE-01 & Lead: T-SYS; partners: T-REV\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN\slash\allowbreak{}T-INT \\
\addlinespace[2pt]
\mbox{PLN-010-03} & Displays, reports, and audit exports shall present the dose basis and assumptions adjacent to each value and shall retain every transformation and source quantity. & U-STACK + C-UX-01; C-TERM-01; C-PLAN-01; C-DOSE-01 & Lead: T-UX; partners: T-DATA\slash\allowbreak{}T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
...
\addlinespace[2pt]
\mbox{PLN-012-01} & Each candidate-plan version shall have a unique immutable identity and shall reference its parent intent, predecessor candidate, parameters, configuration, and calculation outputs. & U-STACK + C-OBJ-01; C-TPS-01; C-WF-01; C-PLAN-01; C-DOSE-01; C-INTENT-01 & Lead: T-DATA; partners: T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN\slash\allowbreak{}T-INT \\
\addlinespace[2pt]
\mbox{PLN-012-02} & Each refinement shall create a new candidate version without overwriting prior parameters, results, warnings, evaluation states, or lineage. & U-STACK + C-PLAN-01; C-WF-01; C-TPS-01; C-DICOM-01; C-DOSE-01 & Lead: T-PLAN; partners: T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN\slash\allowbreak{}T-INT \\
\addlinespace[2pt]
\mbox{PLN-012-03} & Authorized users shall be able to compare any retained candidate versions and reconstruct the ordered refinement history and decision trail. & U-STACK + C-REV-01; C-QA-01; C-TPS-01; C-DICOM-01; C-IAM-01; C-SAFE-01; C-STATE-01; C-WF-01; C-PLAN-01; C-DOSE-01 & Lead: T-REV; partners: T-DATA\slash\allowbreak{}T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN\slash\allowbreak{}T-INT \\
\addlinespace[2pt]
\end{longtable}
\end{scriptsize}
...
\addlinespace[2pt]
\mbox{DAT-001-01} & The clinical-object schema shall require a globally unique identity, version, lifecycle state, owner, creation source, and source linkage for every controlled object type. & U-STACK + C-OBJ-01; C-ARCH-01 & Lead: T-DATA; partners: T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
...
\addlinespace[2pt]
\mbox{DAT-003-02} & Every boundary conversion shall be explicit, versioned, dimensionally validated, and rejected when the source or destination representation is ambiguous or unsupported. & U-STACK + C-OBJ-01; C-DICOM-01; C-DICOM-02; C-TPS-01; C-TERM-01; C-ARCH-01 & Lead: T-DATA; partners: T-INT\slash\allowbreak{}T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\mbox{DAT-003-03} & Verification shall cover storage, calculation, display, export, round-trip, precision, rounding, coordinate-transform, and incompatible-unit cases. & U-STACK + C-TEST-01; C-DICOM-01; C-DICOM-02; C-TERM-01; C-ARCH-01 & Lead: T-VV; partners: T-SYS\slash\allowbreak{}T-CLIN\slash\allowbreak{}T-INT \\
\addlinespace[2pt]
...
\addlinespace[2pt]
\mbox{DAT-005-01} & The deployment conformance statement shall list the supported DICOM SOP classes, roles, transfer syntaxes, transactions, required attributes, and known limitations for each approved interface. & U-STACK + C-DICOM-01; C-DICOM-02; C-TPS-01; C-SBX-01; C-IAM-01; C-SAFE-01; C-STATE-01; C-TERM-01; C-JOB-01; C-ARCH-01 & Lead: T-INT; partners: T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\mbox{DAT-005-02} & The gateway shall import, validate, create, and export only the DICOM objects and transactions approved for the active deployment and operating mode. & U-STACK + C-DICOM-01; C-DICOM-02; C-TPS-01; C-TERM-01; C-JOB-01; C-SBX-01; C-ARCH-01 & Lead: T-INT; partners: T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\mbox{DAT-005-03} & Conformance testing shall use representative and challenge objects for images, registrations, segmentations or structures, plans, ion plans, dose, treatment records, and provenance. & U-STACK + C-TEST-01; C-GOV-01; C-QMS-01; C-ARCH-01 & Lead: T-VV; partners: T-GOV\slash\allowbreak{}T-SYS\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
...
\addlinespace[2pt]
\mbox{DAT-006-02} & The interface shall validate conformance to the approved profile or guide and shall prevent use of an unsupported exchange as though it were conformant. & U-STACK + C-DICOM-01; C-DICOM-02; C-TPS-01; C-ARCH-01 & Lead: T-INT; partners: T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\mbox{DAT-006-03} & The system shall maintain and make available a conformance statement and known-limitations record for every implemented exchange. & U-STACK + C-GOV-01; C-QMS-01; C-UX-01; C-ARCH-01 & Lead: T-GOV; partners: T-UX\slash\allowbreak{}T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
...
\addlinespace[2pt]
\mbox{DAT-007-03} & The interface and audit record shall identify each detected condition, affected object, source, disposition, correction, and reconciliation result. & U-STACK + C-UX-01; C-ARCH-01 & Lead: T-UX; partners: T-DATA\slash\allowbreak{}T-SYS\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
...
\addlinespace[2pt]
\mbox{VAL-004-01} & The end-to-end test plan shall include normal, boundary, rare but foreseeable, wrong-context, partial-failure, timeout, rollback, post-approval change, and recovery scenarios. & U-STACK + C-TEST-01; C-IAM-01; C-SAFE-01; C-STATE-01; C-JOB-01; C-RES-01; C-ARCH-01 & Lead: T-VV; partners: T-SYS\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\mbox{VAL-004-02} & Each scenario shall execute through the official user, model, clinical-service, and interface paths using the release-candidate configuration. & U-STACK + C-TEST-01; C-TPS-01; C-WF-01; C-MGW-01; C-MREG-01; C-ARCH-01 & Lead: T-VV; partners: T-SYS\slash\allowbreak{}T-CLIN\slash\allowbreak{}T-INT \\
\addlinespace[2pt]
...
\begin{scriptsize}
\begin{longtable}{@{}L{0.14\textwidth}L{0.39\textwidth}L{0.25\textwidth}L{0.16\textwidth}@{}}
\toprule
\rowcolor{NLTableHeader}\textbf{Child} & \textbf{Requirement} & \textbf{Realization} & \textbf{Ownership} \\
\midrule
\endfirsthead
\toprule
\rowcolor{NLTableHeader}\textbf{Child} & \textbf{Requirement} & \textbf{Realization} & \textbf{Ownership} \\
...
\bottomrule
\endlastfoot
\rowcolor{NLLight}\multicolumn{4}{@{}L{0.94\textwidth}@{}}{\textbf{Parent ACC-001.} Maintain separately versioned ACR ROPA, ASTRO APEx, technical-guidance, institutional, and modality profiles.} \\
\addlinespace[2pt]
\mbox{ACC-001-01} & Record complete source, authority, integrity, scope, applicability, lifecycle, owner, and approval metadata for sources and atomic assertions. & U-STACK + C-ACC-01; C-EVID-01; C-OBJ-01; C-PROV-01 & Lead: T-EVD; partners: T-GOV\slash\allowbreak{}T-DATA\slash\allowbreak{}T-VV \\
\addlinespace[2pt]
\mbox{ACC-001-02} & Resolve only profiles approved for the active institution, program, modality, machine, technique, task, and release without cross-program tier override. & U-STACK + C-ACC-01; C-RULE-01; C-CFG-01; C-SAFE-01 & Lead: T-EVD; partners: T-SYS\slash\allowbreak{}T-GOV\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\mbox{ACC-001-03} & Suspend affected executable controls after source revision, withdrawal, integrity change, expiry, or program change until impact and reapproval complete. & U-STACK + C-ACC-01; C-QMS-01; C-STATE-01; C-TEST-01 & Lead: T-GOV; partners: T-EVD\slash\allowbreak{}T-SYS\slash\allowbreak{}T-VV \\
\addlinespace[2pt]
\rowcolor{NLLight}\multicolumn{4}{@{}L{0.94\textwidth}@{}}{\textbf{Parent ACC-002.} Require human-approved applicability and prohibit automated accreditation or compliance determinations.} \\
\addlinespace[2pt]
\mbox{ACC-002-01} & Classify each assertion as ENF, SUP, EVD, ORG, or N/A with rationale, scope, ownership, review, and trigger. & U-STACK + C-ACC-01; C-QMS-01; C-REQ-01 & Lead: T-GOV; partners: T-EVD\slash\allowbreak{}T-CLIN\slash\allowbreak{}T-VV \\
\addlinespace[2pt]
\mbox{ACC-002-02} & Require authenticated authorized approval and prohibit AI or service-account applicability approval. & U-STACK + C-ACC-01; C-IAM-01; C-SAFE-01; C-STATE-01 & Lead: T-SEC; partners: T-GOV\slash\allowbreak{}T-SYS\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\mbox{ACC-002-03} & Present readiness and evidence status without stating or implying accreditation or compliance. & U-STACK + C-ACC-02; C-UX-01; C-HFE-01; C-GOV-01 & Lead: T-UX; partners: T-GOV\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\rowcolor{NLLight}\multicolumn{4}{@{}L{0.94\textwidth}@{}}{\textbf{Parent ACC-003.} Maintain atomic bidirectional source-to-release traceability.} \\
\addlinespace[2pt]
\mbox{ACC-003-01} & Preserve stable source parent and atomic-child records, numbering, location, wording status, and parent-child trace. & U-STACK + C-ACC-01; C-REQ-01; C-OBJ-01; C-PROV-01 & Lead: T-DATA; partners: T-EVD\slash\allowbreak{}T-GOV\slash\allowbreak{}T-VV \\
\addlinespace[2pt]
\mbox{ACC-003-02} & Detect missing, orphaned, duplicate, conflicting, stale, untested, unevidenced, or unapproved links and block incomplete profile publication. & U-STACK + C-ACC-01; C-REQ-01; C-VV-01; C-TEST-01; C-SAFE-01 & Lead: T-VV; partners: T-DATA\slash\allowbreak{}T-EVD\slash\allowbreak{}T-SYS \\
\addlinespace[2pt]
\mbox{ACC-003-03} & Invalidate dependent approvals after source, applicability, implementation, evidence, owner, or release change and retain impact and reapproval. & U-STACK + C-ACC-01; C-QMS-01; C-PROV-01; C-AUD-01; C-STATE-01 & Lead: T-DATA; partners: T-GOV\slash\allowbreak{}T-SYS\slash\allowbreak{}T-VV \\
\addlinespace[2pt]
\rowcolor{NLLight}\multicolumn{4}{@{}L{0.94\textwidth}@{}}{\textbf{Parent ACC-004.} Validate required patient, simulation, planning, prescription, consent-status, documentation, and transfer evidence before transition.} \\
\addlinespace[2pt]
\mbox{ACC-004-01} & Define required and conditional fields, status, authorized role, effective time, source, and applicability. & U-STACK + C-DOC-01; C-CASE-01; C-TERM-01; C-OBJ-01 & Lead: T-SYS; partners: T-IMG\slash\allowbreak{}T-DATA\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\mbox{ACC-004-02} & Query approved sources and classify missing, unsigned, stale, inconsistent, wrong-patient, wrong-course, or inapplicable content without creating a professional finding. & U-STACK + C-DOC-01; C-CASE-01; C-DICOM-02; C-FHIR-01; C-SAFE-01 & Lead: T-SYS; partners: T-IMG\slash\allowbreak{}T-INT\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\mbox{ACC-004-03} & Present and retain unmet element, source, affected transition, responsible role, correction, escalation, versions, result, and reconciliation. & U-STACK + C-DOC-01; C-UX-01; C-AUD-01; C-STATE-01 & Lead: T-UX; partners: T-SYS\slash\allowbreak{}T-DATA\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\rowcolor{NLLight}\multicolumn{4}{@{}L{0.94\textwidth}@{}}{\textbf{Parent ACC-005.} Enforce approved patient-verification, QA, review, and invalidation prerequisites and schedules.} \\
\addlinespace[2pt]
\mbox{ACC-005-01} & Calculate due states from authoritative simulation, plan, approval, fraction, treatment, replan, interruption, completion, and policy events with trusted time. & U-STACK + C-DOC-01; C-QA-01; C-RULE-01; C-AUD-01 & Lead: T-SYS; partners: T-REV\slash\allowbreak{}T-EVD\slash\allowbreak{}T-DATA\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\mbox{ACC-005-02} & Block treatment-eligible export or promotion when required identity, timeout, physics, independent-check, PSQA, chart, or EOT evidence is unresolved. & U-STACK + C-DOC-01; C-QA-01; C-SAFE-01; C-STATE-01; C-DICOM-01 & Lead: T-SYS; partners: T-REV\slash\allowbreak{}T-INT\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\mbox{ACC-005-03} & Reconcile events, escalate deadlines, preserve approved emergency distinctions, and retain resolution and exception approval. & U-STACK + C-DOC-01; C-MON-01; C-INC-01; C-AUD-01; C-IAM-01 & Lead: T-OPS; partners: T-SYS\slash\allowbreak{}T-DATA\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\rowcolor{NLLight}\multicolumn{4}{@{}L{0.94\textwidth}@{}}{\textbf{Parent ACC-006.} Require QMP-owned TPS and support-software lifecycle QA and return to service.} \\
\addlinespace[2pt]
\mbox{ACC-006-01} & Register QMP ownership, intended scope, acceptance, commissioning, limitations, reference tests, service, QA, dependencies, and release state. & U-STACK + C-QMS-01; C-CFG-01; C-VV-01; C-MREG-01; C-TPS-01 & Lead: T-VV; partners: T-GOV\slash\allowbreak{}T-AI\slash\allowbreak{}T-INT\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\mbox{ACC-006-02} & Disable clinical use after installation, repair, service, upgrade, change, failed QA, or expiry until assessment, testing, E2E, disposition, and QMP return-to-service approval. & U-STACK + C-SAFE-01; C-STATE-01; C-CFG-01; C-VV-01; C-TEST-01 & Lead: T-SYS; partners: T-VV\slash\allowbreak{}T-GOV\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\mbox{ACC-006-03} & Include all clinically used scripts, autosegmentation, KBP, adaptive, AI, dose/check, and interface tools in commissioning and periodic QA. & U-STACK + C-VV-01; C-TEST-01; C-MGW-01; C-MREG-01; C-MVAL-01; C-TPS-01 & Lead: T-VV; partners: T-AI\slash\allowbreak{}T-PLAN\slash\allowbreak{}T-INT\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\rowcolor{NLLight}\multicolumn{4}{@{}L{0.94\textwidth}@{}}{\textbf{Parent ACC-007.} Maintain attributable, time-ordered, privacy-controlled organizational and accreditation evidence without replacing the responsible process.} \\
\addlinespace[2pt]
\mbox{ACC-007-01} & Record assertion, authoritative system, evidence type, pointer, integrity, owner, scope, period, review, approval, expiration, and limitations. & U-STACK + C-ACC-01; C-ACC-02; C-OBJ-01; C-PROV-01; C-AUD-01 & Lead: T-DATA; partners: T-GOV\slash\allowbreak{}T-EVD\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\mbox{ACC-007-02} & Apply minimum necessary access, local patient-evidence handling, de-identification, recipient/purpose binding, independent export review, and audit. & U-STACK + C-ACC-02; C-SEC-01; C-IAM-01; C-AUD-01 & Lead: T-SEC; partners: T-GOV\slash\allowbreak{}T-DATA\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\mbox{ACC-007-03} & Manage proposal, acceptance, rejection, deficiency, CAPA, effectiveness, and closure states while preserving facility and professional ownership. & U-STACK + C-ACC-02; C-QMS-01; C-INC-01; C-STATE-01 & Lead: T-GOV; partners: T-OPS\slash\allowbreak{}T-DATA\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\rowcolor{NLLight}\multicolumn{4}{@{}L{0.94\textwidth}@{}}{\textbf{Parent ACC-008.} Apply proton controls only to the active commissioned proton scope and mode.} \\
\addlinespace[2pt]
\mbox{ACC-008-01} & Bind room, beamline, mode, machine, energy, CT/stopping-power configuration, algorithm, dose/RBE basis, robustness, motion, QA, and release to the case. & U-STACK + C-PBT-01; C-CASE-01; C-PLAN-01; C-TPS-01; C-CFG-01 & Lead: T-PLAN; partners: T-IMG\slash\allowbreak{}T-INT\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\mbox{ACC-008-02} & Require applicable uncertainty, robustness, algorithm, CT, PSQA, independent, external-validation, readiness, chart-review, and annual-report evidence. & U-STACK + C-PBT-01; C-QA-01; C-VV-01; C-TEST-01; C-DICOM-02 & Lead: T-VV; partners: T-PLAN\slash\allowbreak{}T-REV\slash\allowbreak{}T-INT\slash\allowbreak{}T-CLIN \\
\addlinespace[2pt]
\mbox{ACC-008-03} & Fail closed on profile mismatch, unknown value, expiry, unsupported mode, failed QA, deviation, or absent return-to-service and route to QMP control. & U-STACK + C-PBT-01; C-SAFE-01; C-STATE-01; C-QA-01; C-IAM-01 & Lead: T-SYS; partners: T-PLAN\slash\allowbreak{}T-REV\slash\allowbreak{}T-VV\slash\allowbreak{}T-CLIN \\
\end{longtable}
\end{scriptsize}
...
\addlinespace[2pt]
ACC & Accreditation and practice-quality profiles & 8 & 24 & 13 \\
\addlinespace[2pt]
\textbf{TOTAL} & \textbf{Complete allocation baseline} & \textbf{119} & \textbf{357} & \textbf{116} \\
\end{longtable}
\end{small}
...
\bottomrule
\endlastfoot
C-GOV-01 & Clinical Governance and Release Authority & 56 \\
\addlinespace[2pt]
C-QMS-01 & Quality, Change, Document, and CAPA System & 60 \\
\addlinespace[2pt]
C-REQ-01 & Requirements, Risk, and Traceability Repository & 3 \\
\addlinespace[2pt]
C-ARCH-01 & Architecture and Interface Contract Registry & 19 \\
\addlinespace[2pt]
C-IAM-01 & Identity, Role, and Approval Service & 115 \\
\addlinespace[2pt]
C-SAFE-01 & Deterministic Safety Kernel & 146 \\
\addlinespace[2pt]
C-STATE-01 & Clinical Lifecycle and Workflow State Engine & 145 \\
\addlinespace[2pt]
C-UX-01 & Clinical Command, Review, and Confirmation Workspace & 65 \\
\addlinespace[2pt]
C-HFE-01 & Human-Factors, Training, and Competency Program & 13 \\
\addlinespace[2pt]
C-VOICE-01 & Push-to-Talk and Transcript Confirmation Service & 17 \\
\addlinespace[2pt]
C-INTENT-01 & Typed Intent Compiler and Deterministic Validator & 22 \\
\addlinespace[2pt]
C-WF-01 & Clinical Workflow Orchestrator & 54 \\
\addlinespace[2pt]
C-EVID-01 & Approved Evidence Repository and Retrieval Service & 60 \\
\addlinespace[2pt]
C-RULE-01 & Computable Rule and Authority Resolver & 61 \\
\addlinespace[2pt]
C-ACC-01 & Accreditation Profile and Applicability Registry & 9 \\
\addlinespace[2pt]
C-DOC-01 & Clinical Documentation Completeness and Temporal Gate & 6 \\
\addlinespace[2pt]
C-ACC-02 & Accreditation Evidence, Deficiency, and Export Workspace & 4 \\
\addlinespace[2pt]
C-PBT-01 & Proton Planning and QA Profile Adapter & 6 \\
\addlinespace[2pt]
C-CASE-01 & Clinical Context and Case Manifest Service & 10 \\
\addlinespace[2pt]
C-REG-01 & Registration and Derived-Dose Service & 6 \\
\addlinespace[2pt]
C-SEG-01 & Contouring Gateway and Anatomy Review Service & 20 \\
\addlinespace[2pt]
C-PLAN-01 & Planning Intent and Candidate Orchestrator & 37 \\
\addlinespace[2pt]
C-DOSE-01 & Commissioned Optimizer and Dose-Service Adapter & 33 \\
\addlinespace[2pt]
C-REV-01 & Plan Comparison, Selection, and Approval Workspace & 17 \\
\addlinespace[2pt]
C-QA-01 & QA Routing and Independent Verification Coordinator & 21 \\
\addlinespace[2pt]
C-DICOM-01 & DICOM and DICOM-RT Exchange Gateway & 83 \\
\addlinespace[2pt]
C-DICOM-02 & DICOM Conformance, Validation, and Reconciliation Service & 44 \\
\addlinespace[2pt]
C-TPS-01 & Existing TPS Adapter Framework & 78 \\
\addlinespace[2pt]
C-FHIR-01 & IHE-RO, FHIR, and CodeX Adapter & 1 \\
\addlinespace[2pt]
C-TERM-01 & Terminology, Units, Coordinates, and Nomenclature Service & 40 \\
\addlinespace[2pt]
C-OBJ-01 & Versioned Clinical Object Repository & 57 \\
\addlinespace[2pt]
C-PROV-01 & Provenance and Dependency Graph & 4 \\
\addlinespace[2pt]
C-AUD-01 & Tamper-Evident Audit Ledger & 13 \\
\addlinespace[2pt]
C-CFG-01 & Configuration, Policy, and Release Registry & 4 \\
\addlinespace[2pt]
C-MGW-01 & Clinical Model Gateway and Runtime Contract Validator & 60 \\
\addlinespace[2pt]
C-MREG-01 & Model and Dependency Registry & 60 \\
\addlinespace[2pt]
C-MVAL-01 & Model Validation and Production Monitoring Service & 12 \\
\addlinespace[2pt]
C-SEC-01 & Security and Privacy Control Plane & 24 \\
\addlinespace[2pt]
C-MON-01 & Monitoring, Alerting, and Service-Level Service & 43 \\
\addlinespace[2pt]
C-JOB-01 & Atomic Job and Transaction Coordinator & 38 \\
\addlinespace[2pt]
C-RES-01 & Backup, Recovery, and Degraded Operations Service & 38 \\
\addlinespace[2pt]
C-INC-01 & Incident, Near-Miss, and CAPA Workflow & 39 \\
\addlinespace[2pt]
C-VV-01 & Verification, Validation, and Commissioning Harness & 5 \\
\addlinespace[2pt]
C-TEST-01 & Locked Reference and Challenge Case Library & 45 \\
\addlinespace[2pt]
