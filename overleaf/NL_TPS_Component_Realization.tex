...
\begin{scriptsize}
\begin{longtable}{@{}L{0.14\textwidth}L{0.43\textwidth}L{0.25\textwidth}L{0.16\textwidth}@{}}
\toprule
...
\addlinespace[2pt]
C-ACC-01 & Accreditation Profile and Applicability Registry & 10 \\
\addlinespace[2pt]
C-DOC-01 & Clinical Documentation Completeness and Temporal Gate & 6 \\
\addlinespace[2pt]
C-ACC-02 & Accreditation Evidence, Deficiency, and Export Workspace & 5 \\
\addlinespace[2pt]
C-PBT-01 & Proton Planning and QA Profile Adapter & 3 \\
\addlinespace[2pt]
...
\addlinespace[2pt]
C-PLAN-01 & Planning Intent and Candidate Orchestrator & 20 \\
\addlinespace[2pt]
