...
\hypersetup{pdftitle={Functional, Safety-Assurance, and Operational Sub-Requirements},pdfsubject={NL-TPS controlled documentation}}
\begin{document}
\NLSetPageStyle{NL-TPS F/SA/O SUB-REQUIREMENTS}{NL-TPS categorized F/SA/O High-Level Requirements v0.2}
\NLTitleBlock{SYSTEM REQUIREMENTS BASELINE}{Functional, Safety / Assurance, and Operational Sub-Requirements}{Complete decomposition and immutable source trace}{\begin{minipage}{0.95\textwidth}
\NLMeta{Source baseline}{NL-TPS categorized F/SA/O High-Level Requirements v0.2}
...
\NLMeta{Coverage}{357 requirements: 207 functional; 75 safety / assurance; 75 operational}
...
\addlinespace[2pt]
Source document & NL-TPS High-Level Functional, Safety-Assurance, and Operational Requirements, Version 0.1 \\
\addlinespace[2pt]
...
\addlinespace[2pt]
Coverage & 357 requirements: 207 functional; 75 safety / assurance; 75 operational \\
\addlinespace[2pt]
...
This specification realizes the 119 categorized high-level requirements through all 357 existing lower-level obligations: 207 functional, 75 cross-cutting safety and assurance, and 75 operational sub-requirements. Each parent retains three children covering controlled definition or configuration, enforceable behavior or workflow, and retained verification or audit evidence.

No child obligation has been summarized away. The exact source text, legacy allocation code, and anticipated V\&V methods are preserved. HNFR, NFSR, and NFC identifiers remain stable legacy aliases while the authoritative class is functional, cross-cutting safety and assurance, or operational.
...
\addlinespace[2pt]
Safety / assurance & SAF & Safety boundaries and human authority & 10 & 30 \\
\addlinespace[2pt]
Safety / assurance & HFE & Human factors, usability, and competency & 6 & 18 \\
\addlinespace[2pt]
Safety / assurance & SEC & Privacy, cybersecurity, and secure development & 8 & 24 \\
\addlinespace[2pt]
Safety / assurance & ACC & Human accreditation authority and claim limitation & 1 & 3 \\
\addlinespace[2pt]
...
\section{Cross-cutting safety and assurance sub-requirements}
...
\addlinespace[2pt]
Safety / assurance & 25 & 75 & 75 & 3.00 & Pass \\
\addlinespace[2pt]
