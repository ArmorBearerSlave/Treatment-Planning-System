...
\hypersetup{pdftitle={High-Level Functional, Safety-Assurance, and Operational Requirements},pdfsubject={NL-TPS controlled documentation}}
\begin{document}
\NLSetPageStyle{NL-TPS F/SA/O HIGH-LEVEL REQUIREMENTS}{NL-TPS High-Level Requirements v0.1 and ConOps v0.1}
\NLTitleBlock{SYSTEM REQUIREMENTS BASELINE}{High-Level Functional, Safety / Assurance, and Operational Requirements}{Natural-Language Treatment Planning System (NL-TPS)}{\begin{minipage}{0.95\textwidth}
\NLMeta{Source baseline}{NL-TPS High-Level Requirements v0.1 and ConOps v0.1}
\NLMeta{Requirements version}{0.2 - Reclassified proposed baseline}
\NLMeta{Date}{19 August 2026}
\NLMeta{Status}{Discussion Draft - Not for clinical use}
\NLMeta{Coverage}{119 requirements: 69 functional; 25 safety / assurance; 25 operational}
\end{minipage}}{This document provides a controlled functional, cross-cutting safety and assurance, and operational view of the existing NL-TPS high-level baseline. Legacy HNFR identifiers remain stable aliases. It is not a clinical protocol, commissioning report, regulatory determination, released product specification, or authorization for patient use.}
...
\addlinespace[2pt]
Coverage & 119 requirements: 69 functional; 25 safety / assurance; 25 operational \\
\addlinespace[2pt]
Identifier policy & New category IDs retain immutable source aliases to the original 119 HLR identifiers. \\
\addlinespace[2pt]
...
This specification organizes the complete 119-requirement source baseline into three primary realization classes: 69 functional requirements, 25 cross-cutting safety and assurance constraints, and 25 operational requirements. The partition distinguishes delivered behavior, safety and assurance constraints, and institutional controls needed to deploy and sustain it.

The original requirement wording, source/hazard trace, and anticipated verification methods are preserved. HNFR, NFSR, and NFC identifiers remain stable legacy trace aliases, not classifications or replacements. Cross-cutting effects remain valid: an operational control or safety and assurance constraint may require functional enforcement.
...
The purpose of this document is to establish a reviewable functional, safety and assurance, and operational taxonomy beneath the ConOps and alongside the source High-Level Requirements. It supports architecture allocation, hazard analysis, subsystem specifications, verification planning, commissioning, team ownership, and release decisions without silently changing the source baseline.
...
\bottomrule
\endlastfoot
Functional & HFR & FSR & Capabilities that accept, transform, calculate, present, exchange, or govern patient-specific planning information and candidate plans. & 69 & 207 \\
\addlinespace[2pt]
Safety / assurance & HNFR (legacy) & NFSR (legacy) & Cross-cutting safety, human-factors, privacy, security, integrity, and assurance constraints on every applicable function. & 25 & 75 \\
\addlinespace[2pt]
Operational & HOR & OSR & Institutional governance, deployment, monitoring, resilience, verification, commissioning, release, and lifecycle obligations needed to operate the system safely. & 25 & 75 \\
\addlinespace[2pt]
\end{longtable}
\end{scriptsize}
...
\addlinespace[2pt]
Functional & ACC & Accreditation-profile, clinical-documentation, QA, and proton capabilities & 5 & 15 & HFR-ACC-001 through HFR-ACC-005 \\
\addlinespace[2pt]
Safety / assurance & SAF & Safety boundaries and human authority & 10 & 30 & HNFR-SAF-001 through HNFR-SAF-010 \\
\addlinespace[2pt]
Safety / assurance & HFE & Human factors, usability, and competency & 6 & 18 & HNFR-HFE-001 through HNFR-HFE-006 \\
\addlinespace[2pt]
Safety / assurance & SEC & Privacy, cybersecurity, and secure development & 8 & 24 & HNFR-SEC-001 through HNFR-SEC-008 \\
\addlinespace[2pt]
Safety / assurance & ACC & Human accreditation authority and claim limitation & 1 & 3 & HNFR-ACC-001 \\
\addlinespace[2pt]
...
\addlinespace[2pt]
Operational & ACC & Physicist lifecycle governance and organizational evidence & 2 & 6 & HOR-ACC-001 through HOR-ACC-002 \\
\addlinespace[2pt]
TOTAL & All & Complete categorized baseline & 119 & 357 & All source IDs represented exactly once \\
\addlinespace[2pt]
\end{longtable}
\end{scriptsize}
...
\bottomrule
\endlastfoot
\mbox{HFR-ACC-001} & \mbox{ACC-001} & The NL-TPS shall maintain versioned, human-approved ACR ROPA and ASTRO APEx profiles with source edition, criterion identity, applicability, local interpretation, effective state, and supersession history. & ACR; APEx; QMS & I\slash\allowbreak{}T \\
\addlinespace[2pt]
\mbox{HFR-ACC-002} & \mbox{ACC-003} & The NL-TPS shall provide atomic bidirectional trace from each applicable profile obligation through requirements, controls, components, procedures, evidence, tests, findings, corrective actions, and release decisions. & ACR; APEx; TRACE & I\slash\allowbreak{}T \\
\addlinespace[2pt]
\mbox{HFR-ACC-003} & \mbox{ACC-004} & The NL-TPS shall evaluate defined clinical-documentation completeness and temporal dependencies for simulation, prescription, planning, review, transfer, and treatment-readiness workflows. & ACR; APEx; H-01 & T\slash\allowbreak{}HFE \\
\addlinespace[2pt]
\mbox{HFR-ACC-004} & \mbox{ACC-005} & The NL-TPS shall enforce configured review and QA schedules, including peer review, chart review, physics checks, pretreatment verification, and documented exception handling. & ACR; APEx; QA & T\slash\allowbreak{}D \\
\addlinespace[2pt]
\mbox{HFR-ACC-005} & \mbox{ACC-008} & The NL-TPS shall maintain a proton-specific profile for robust planning, range and setup uncertainty, motion, image guidance, patient-specific QA, delivery compatibility, and change-triggered revalidation. & ACR; APEx; PBT & T\slash\allowbreak{}A \\
\end{longtable}
\end{scriptsize}

\section{Cross-cutting safety and assurance high-level requirements}
...
\bottomrule
\endlastfoot
\mbox{HNFR-ACC-001} & \mbox{ACC-002} & The NL-TPS shall preserve human authority for applicability, compliance, and accreditation determinations and shall not represent system output as accreditation, certification, or surveyor judgment. & ACR; APEx; AUTH & I\slash\allowbreak{}HFE \\
\end{longtable}
\end{scriptsize}
...
\bottomrule
\endlastfoot
\mbox{HOR-ACC-001} & \mbox{ACC-006} & A qualified medical physicist shall govern TPS and model lifecycle QA, commissioning, periodic and change-triggered testing, anomaly disposition, rollback, and return to service. & ACR; APEx; QMP & I\slash\allowbreak{}A \\
\addlinespace[2pt]
\mbox{HOR-ACC-002} & \mbox{ACC-007} & The NL-TPS shall support controlled organizational accreditation evidence while protecting patient information and preserving local ownership of staffing, credentials, training, policy, safety, and quality decisions. & ACR; APEx; QMS & I\slash\allowbreak{}A \\
\end{longtable}
\end{scriptsize}

\section{Cross-category realization and acceptance}

Functional completion alone is insufficient for clinical readiness. Each included function shall be paired with its applicable safety and assurance constraints and operational controls through the requirements, risk, interface, component, and verification traces. A release gate shall reject orphan functions, unverified controls, unresolved safety-significant anomalies, uncommissioned external TPS pathways, and unsupported clinical scope.
...
\bottomrule
\endlastfoot
Functional & 69 & 69 & 207 & NLI, EVD, CLN, PLN, REV, DAT, AIM, ACC & Pass \\
\addlinespace[2pt]
Safety / assurance & 25 & 25 & 75 & SAF, HFE, SEC, ACC & Pass \\
\addlinespace[2pt]
Operational & 25 & 25 & 75 & GOV, OPS, VAL, ACC & Pass \\
\addlinespace[2pt]
TOTAL & 119 & 119 & 357 & 14 domains & Pass \\
\addlinespace[2pt]
\end{longtable}
\end{small}
