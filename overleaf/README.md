...
- `main.tex` - default entry point for the Component Realization document
...
2. The default `main.tex` compiles the Component Realization document. To compile another
   controlled document,
...
The four files are intentionally separate controlled documents. Select one as
