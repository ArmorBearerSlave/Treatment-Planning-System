...
Add-Line '\NLMeta{Coverage}{2,144 unique checks: 1,940 requirement checks and 204 component or subassembly checks}'
...
function Add-MatrixHeader {
    ...
    Add-Line '\begin{longtable}{@{}L{0.13\textwidth}L{0.25\textwidth}L{0.20\textwidth}L{0.23\textwidth}L{0.085\textwidth}@{}}'
    Add-Line '\toprule'
